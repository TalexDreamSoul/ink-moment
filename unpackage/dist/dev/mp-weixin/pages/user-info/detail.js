  ...
  return {
    a: common_vendor.w(({
      ...
      return common_vendor.e({
        ...
        m: "5ed3a3a3-3-" + i0 + ",5ed3a3a3-0",
        n: common_vendor.p({
          href: "mailto:" + data.email,
          text: data.email
        }),
        o: "5ed3a3a3-4-" + i0 + ",5ed3a3a3-0",
        p: common_vendor.p({
          href: data.url,
          download: data.url,
          text: data.url
    ...
    b: common_vendor.sr("udb", "5ed3a3a3-0"),
    c: common_vendor.p({
