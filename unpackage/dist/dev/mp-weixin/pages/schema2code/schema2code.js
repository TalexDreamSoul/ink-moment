...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    b: common_vendor.o((...args) => $options.showSchemaCode && $options.showSchemaCode(...args)),
    c: common_vendor.p({
      src: $data.videoUrl,
    ...
    d: common_vendor.sr("alertCode", "d1e4428e-1"),
    e: common_vendor.o((...args) => $options.toForm && $options.toForm(...args))
  };
}
