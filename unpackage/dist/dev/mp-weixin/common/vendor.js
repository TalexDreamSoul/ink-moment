...
const pages = [
  ...
  {
    path: "pages/supervisor/audit-list",
    style: {
  ...
  {
    path: "pages/supervisor/audit-detail",
    style: {
  ...
  {
    path: "pages/supervisor/statistics",
    style: {
      navigationBarTitleText: "督导统计",
      enablePullDownRefresh: true
    }
  },
  {
